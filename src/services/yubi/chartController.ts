...
/** listMyChartByPage POST /api/aide/myai/list/page */
export async function listMyAiByPageUsingPOST(
  body: API.AiAssistantQueryRequest,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponsePageAiAssistant_>('/api/aide/myai/list/page', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
